...
<form action="output/resume<?php echo $_GET["tmp"]; ?>.php" method="post" class="basic-grey">
			...
			<div class="education">
				<div class="input_fields_wrap">					
					<input type="text" name="education[]" placeholder="Education 1">
				</div>
			...
			<div class="work">
				<div class="input_fields_wrap">					
					<input name="work[]" placeholder="Work Experience 1 Title" type="text" /><span></span><input name="work_desc[]" placeholder="Work Experience 1 Description" type="text" />
				</div>
				<button class="button add_field_button">Add More Fields</button>
			</div>
